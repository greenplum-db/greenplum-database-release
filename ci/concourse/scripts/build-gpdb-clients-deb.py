...
class BuildAndTestPPA:
    def build(self):
        if os.path.isfile("bin_gpdb/bin_gpdb_clients.tar.gz"):
            tarball_path="bin_gpdb/bin_gpdb_clients.tar.gz"
        else:
            tarball_path=glob.glob("bin_gpdb_clients/clients-*.tar.gz")[0]
        ...
        shutil.copy(deb_file_path, os.path.join("gpdb_clients_deb_installer", "greenplum-db-6-ubuntu18.04-amd64.deb"))
