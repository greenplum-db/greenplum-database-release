...
# Get all file names in $GPHOME directory excluding python2.7 directory and python3.11 directory
file_names=($(find "${GPHOME}" \( -path "${GPHOME}"/ext/python/lib/python2.7 -prune -o -path "${GPHOME}"/ext/python3.11/lib/python3.11 -prune \) -o -type f))
